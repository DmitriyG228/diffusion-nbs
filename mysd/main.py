...
# %% auto 0
__all__ = ['torch_device', 'vae', 'tokenizer', 'text_encoder', 'unet', 'scheduler', 'batch_size', 'height', 'width',
           'num_inference_steps', 'guidance_scale', 'generator', 'select_cuda', 'text2vector', 'random_latents',
           'pil_to_latent', 'latents_to_pil', 'img2latents', 'loop']
...
# %% ../main.ipynb 14
def loop(text_embeddings,latents,start_step=0,guidance_scale=7.5):
